...
import animation.dialog.widget.internal.BaseAlertDialog;
...
public class NormalDialog extends BaseAlertDialog<NormalDialog> {
    ...
    public void setUiBeforShow() {
        ...
        tv_btn_left.setBackgroundDrawable(CornerUtils.btnSelector(radius, bg_left_Color, btnPressColor, 0));
        tv_btn_right.setBackgroundDrawable(CornerUtils.btnSelector(radius, bg_right_Color, btnPressColor, 1));
        tv_btn_middle.setBackgroundDrawable(CornerUtils.btnSelector(btnNum == 1 ? radius : 0, bg_middle_Color, btnPressColor, -1));
    }
