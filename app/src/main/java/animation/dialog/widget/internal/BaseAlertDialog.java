package animation.dialog.widget.internal;
...
import animation.dialog.listener.OnBtnClickL;
...
public abstract class BaseAlertDialog<T extends BaseAlertDialog<T>> extends BaseDialog {
    ...
    protected int bg_left_Color = Color.parseColor("#ffffff");
    protected int bg_right_Color = Color.parseColor("#ffffff");
    protected int bg_middle_Color = Color.parseColor("#ffffff");
    ...
    public void setUiBeforShow() {
        ...
        tv_btn_left.setBackgroundColor(bg_left_Color);
        tv_btn_right.setBackgroundColor(bg_right_Color);
        tv_btn_middle.setBackgroundColor(bg_middle_Color);
    ...
    /**
     * set btn textcolor(设置按钮背景颜色)
     * btnTextColors size 1, middle
     * btnTextColors size 2, left right
     * btnTextColors size 3, left right middle
     */
    public T btnTextbgColor(int... btnbgColors) {
        if (btnbgColors.length < 1 || btnbgColors.length > 3) {
            throw new IllegalStateException(" range of param textColors length is [1,3]!");
        }

        if (btnbgColors.length == 1) {
            this.bg_middle_Color = btnbgColors[0];
        } else if (btnbgColors.length == 2) {
            this.bg_left_Color = btnbgColors[0];
            this.bg_right_Color = btnbgColors[1];
        } else if (btnbgColors.length == 3) {
            this.bg_left_Color = btnbgColors[0];
            this.bg_middle_Color = btnbgColors[1];
            this.bg_right_Color = btnbgColors[2];
        }
